...
(function (port) {
        ...
        serve = function (req, res) {
            ...
            var handleResult = function (result, redirect) {
                    if (redirect) {
                        ...
                        // fetch to create manifest and bind the mId to the result
                        // @ref: https://stackoverflow.com/questions/24912226/how-to-make-ajax-request-through-nodejs-to-an-endpoint
                        var manifest_API = 'http://172.16.100.20:3033/api/GET/15/manifest';
                        var creating_manifest = function (callback) {
                        ...
                        creating_manifest(function (mId) {
                            // setting manifest URL for each pictures
                            if (result['files'])
                                result['files'][0]['manifest'] = 'http://172.16.100.20:3033/api/GET/15/manifest';
    ...
    UploadHandler.prototype.post = function () {
        ...
        ssh.connect({
            ...
            // Local, Remote
            ssh.putFile('/var/www/html/media', '/var/lib/rancher/volumes/rancher-nfs/Horovod_Node_data/joffrey/yolo').then(function () {
